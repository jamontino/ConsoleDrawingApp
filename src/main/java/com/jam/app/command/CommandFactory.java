...
import com.jam.app.command.rule.CommandRule;
import com.jam.app.command.rule.IntegerParameterRule;
import com.jam.app.command.rule.NumberOfParamsRule;
import com.jam.app.command.rule.SingleCharParameterRule;

import java.util.ArrayList;
import java.util.List;

import static com.jam.app.command.CommandType.*;
